  ...
  render: function() {
    return (
      React.DOM.ul( {className:"TabBar"}, 
        React.DOM.li( {className:"active"}, React.DOM.i( {className:"fa fa-phone"})),
...
var NewCallView = React.createClass({displayName: 'NewCallView',
  ...
  onClick: function() {
    if(this.state.callName == '') {
      $(this.getDOMNode()).addClass('error');
      return;
    }
    $(this.getDOMNode()).removeClass('error');
    this.setState({
      hasLink: true
    })
  },
...
var SearchBar = React.createClass({displayName: 'SearchBar',
  render: function(){
    return (
      React.DOM.div( {class:"SearchBarWrapper"}, 
        React.DOM.input( {className:"SearchBar", value:this.props.val, onChange:this.props.handleChange, placeholder:"Search..."}),React.DOM.i( {className:"fa fa-cog"})
      )
    )
  }
});
