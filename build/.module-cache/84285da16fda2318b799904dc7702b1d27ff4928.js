...
var Profile = React.createClass({displayName: 'Profile',
  render: function(){
    return (
      React.DOM.div( {onClick:this.props.onClick, className:["Profile", this.props.selected].join(' ')} , 
...
var List = React.createClass({displayName: 'List',
  ...
  render: function(){
    ...
    var viewForItem = function(item, index){
      ...
      return Profile( {onClick:onClick, 'data-index':index, key:index, user:item, selected:isSelected} )
    }.bind(this);
