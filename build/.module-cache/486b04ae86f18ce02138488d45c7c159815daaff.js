    ...
    return (
      React.DOM.div( {className:"header"}, 
        React.DOM.h6(null, 
          ...
          React.DOM.span( {className:"right"}, React.DOM.a(null, this.props.editText), " or ", React.DOM.a(null, this.props.linkText))
        ),
...
var PrecallSignedIn = React.createClass({displayName: 'PrecallSignedIn',
  render: function() {
    return (
        BaseState( {name: this.props.name,  index: this.props.index }, 
          Panel( {items: this.props.items }, 
            Header( {username:"Ally", linkText:"Sign Out", editText:"Profile"}),
            SearchBar(null ),
