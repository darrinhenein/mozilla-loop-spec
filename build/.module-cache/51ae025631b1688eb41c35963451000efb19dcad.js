  ...
  render: function(){
    return (
      React.DOM.div( {className:"HistoryList"}, 
        React.DOM.h3(null, React.DOM.span(null, STRINGS.callHistory), " ", React.DOM.span( {className:"Button"}, STRINGS.clearHistory)),
        React.DOM.ul( {className:"CallHistory"}, 
          _.range(10).map(function(i){
            ...
            if(callType === 'incoming') {
              callIcon = React.DOM.i( {className:"fa right fa-arrow-right"})
            } else {
              callIcon = React.DOM.i( {className:"fa right fa-arrow-left"})
            }
            return (
