...
var PanelGroup = React.createClass({displayName: 'PanelGroup',
  ...
  componentDidMount: function() {
    $(this).on('PanelGroup::slide', function(event, data){
      this.slideTo(data.loc);
    }).bind(this);
  },
  componentWillUnmount: function() {
    $(this).off('PanelGroup::slide');
  },
  render: function(){
    return (
...
var Header = React.createClass({displayName: 'Header',
  ...
  onClick: function() {
    $(this).trigger('PanelGroup::slide', {loc: '-90%'});
  },
  render: function(){
    return (
      React.DOM.div( {className:"Header"}, 
        ...
        Button( {text:"Video Call", style:"action", onClick:this.props.slideTo})
      )
    )
  }
});
