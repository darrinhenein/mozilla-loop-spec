...
var SliderButton = React.createClass({displayName: 'SliderButton',
  ...
  showDrawer: function(){
    ...
    $(this.refs.button.getDOMNode()).velocity({
      backgroundColorRed: '+90%',
      backgroundColorGreen: '-20%',
      backgroundColorBlue: '-60%',
    });
  },
  hideDrawer: function(){
  ...
  render: function() {
    return (
      React.DOM.div( {className:"SliderButton"}, 
        Button( {text:this.state.text, ref:"button", style:this.props.style, onClick:this.toggleDrawer}),
  ...
  render: function(){
    return (
      React.DOM.div( {className:"Header"}, 
        ...
        SliderButton( {text:"New Video Call", style:"action"})
      )
    )
  }
});
