...
var PanelGroup = React.createClass({displayName: 'PanelGroup',
  ...
  componentDidMount: function() {
    ...
    var group = this;
    $(this.getDOMNode()).on('PanelGroup::slide', function(event, data){
      console.log(data);
      group.slideTo(data.loc);
    });
  },
  componentWillUnmount: function() {
    $(this.getDOMNode()).off('PanelGroup::slide');
  },
  render: function(){
    return (
...
var Header = React.createClass({displayName: 'Header',
  ...
  onClick: function() {
    $(this.getDOMNode()).trigger('PanelGroup::slide', {loc: '-90%'});
  },
  render: function(){
    return (
