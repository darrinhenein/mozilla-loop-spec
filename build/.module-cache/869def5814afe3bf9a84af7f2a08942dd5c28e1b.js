...
var SliderButton = React.createClass({displayName: 'SliderButton',
  ...
  showDrawer: function(){
    $(this.refs.drawer.getDOMNode()).addClass('active');
  },
  hideDrawer: function(){
    $(this.refs.drawer.getDOMNode()).removeClass('active');
  },
    ...
    return (
      React.DOM.div( {className:"SliderButton"}, 
        ...
        React.DOM.div( {ref:"drawer", className:"drawer"}, 
          React.DOM.input( {value:"http://lo.op/9812ye9"}),
          React.DOM.div( {class:"inputButton"}, "Copy")
        )
      )
    )
  }
