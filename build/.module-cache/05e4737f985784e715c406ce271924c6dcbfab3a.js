...
var SliderButton = React.createClass({displayName: 'SliderButton',
  ...
  toggleDrawer: function(){
    ...
    this.setState({
      ...
      buttonClass:  this.state.isDrawerShown ? 'active' : 'cancel'
    });
  },
  render: function() {
    return (
      React.DOM.div( {className:"SliderButton"}, 
        Button( {text:this.state.text, className:this.state.buttonClass, style:this.props.style, onClick:this.toggleDrawer}),
