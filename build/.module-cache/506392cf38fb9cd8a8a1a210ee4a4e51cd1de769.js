...
var Button = React.createClass({displayName: 'Button',
  render: function() {
    return (
      React.DOM.div( {onClick:this.props.onClick, className:"Button " + this.props.style },  this.props.children )
    )
  }
});
...
var SliderButton = React.createClass({displayName: 'SliderButton',
  ...
  showInput: function(){
    $(this.refs.sliderInput.getDOMNode()).addClass('active');
  },
  hideInput: function(){
    $(this.refs.sliderInput.getDOMNode()).removeClass('active');
  },
  ...
  render: function() {
    return (
      React.DOM.div( {className:"SliderButton"}, 
        Button( {style:this.props.style, onClick:this.toggleDrawer}, 
           this.props.children 
        ),
        React.DOM.div( {className:"drawer"}, 
          React.DOM.input( {ref:"sliderInput", value:"Hello"})
        )
      )
    )
  }
