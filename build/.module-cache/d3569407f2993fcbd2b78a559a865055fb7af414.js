  ...
  render: function(){
    ...
    return (
      React.DOM.div( {className:"List"}, 
        SearchBar( {ref:"filterSearchBar", handleChange:this.handleKeyUp} ),
...
var SearchBar = React.createClass({displayName: 'SearchBar',
  render: function(){
    return (
      React.DOM.input( {className:"SearchBar", onChange:this.props.handleKeyUp.bind(null,this), placeholder:"Search..."})
    )
  }
})
